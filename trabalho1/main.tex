...
\input{secoes/falas}  %Explanação rápida: Esse comando coloca o conteúdo do arquivo falas.tex, que está na pasta seções nesse arquivo
\input{secoes/pedido_especial}
